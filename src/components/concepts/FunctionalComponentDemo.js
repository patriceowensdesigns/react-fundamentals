        ...
        <Container className='main'>
            <Row>
                <Col xs="12">
                    ...
                    <dl>
                        <dt>Can use state</dt>
                        <dd>With the 'useState' hook, functional components can now both render a display to the page and update the information to sbe shown.</dd>
                        <dt>No 'this' keyword</dt>
                        <dd>Older class components us 'this', functional components have no 'this' object.</dd>
